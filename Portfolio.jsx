...
const DATA = {
  ...
  stats: [
    ...
    { label: "Azure AI-900", value: "Certificates", icon: "☁️", color: "#38BDF8" },
    { label: "Publications", value: "2", icon: "📄", color: "#10B981" },
  ],
  projects: [
  ...
  certs: [
    { title: "ICAC 2024 — Satellite Image Dehazing", issuer: "Bharathiar University", date: "Sep 2024", icon: "🎓", color: "#7C3AED", url: "https://drive.google.com/file/d/1BbPMpd2fFPYWrukRV0U2OvaYMc9FUhxN/view" },
    { title: "What Is Generative AI?", issuer: "LinkedIn Learning", date: "Apr 2025", icon: "🤖", color: "#0077B5", url: "#" },
    { title: "Microsoft Azure AI Essentials", issuer: "LinkedIn Learning", date: "Apr 2025", icon: "☁️", color: "#0078D4", url: "#" },
    { title: "Ethics in the Age of Generative AI", issuer: "LinkedIn Learning", date: "Apr 2025", icon: "⚖️", color: "#38BDF8", url: "#" },
    { title: "Introduction to DevOps", issuer: "Great Learning Academy", date: "Oct 2024", icon: "🔄", color: "#10B981", url: "https://www.mygreatlearning.com/certificate/XQVYQZTG" },
    { title: "Peopleclick Internship", issuer: "Peopleclick Techno Solutions", date: "Dec 2025", icon: "💼", color: "#FB7185", url: "https://drive.google.com/file/d/1BbPMpd2fFPYWrukRV0U2OvaYMc9FUhxN/view" },
    { title: "TCS Big Data Analytics — Advanced", issuer: "TCS iON", date: "2025", icon: "📊", color: "#F59E0B", url: "https://drive.google.com/file/d/1VJvPk1m_4pes_NOoRfF8iGA4m6TjMelM/view" },
    { title: "TCS Data Modeling & Visualization", issuer: "TCS iON", date: "2025", icon: "📈", color: "#6366F1", url: "https://drive.google.com/file/d/1brrJKPRwD2rjLn4r9Gh8jR2KsUk6JZsS/view" },
    { title: "Azure AI-900", issuer: "Microsoft", date: "Pending upload", icon: "🏅", color: "#0078D4", url: "#" },
  ],
  publications: [
      ...
      <div className="carousel-wrap glass" style={{ padding: pad }}>
        <motion.div className="carousel-track" drag="x" dragConstraints={{ left: -trackOffset * (loop.length - 1), right: 0 }} style={{ width: "max-content", gap: GAP, perspective: 1000, x }} animate={{ x: -(pos * trackOffset) }} transition={jumping ? { duration: 0 } : SPRING} onDragEnd={handleDragEnd} onAnimationComplete={handleAnimEnd}>
          {loop.map((item, i) => {
            ...
            const rotY = useTransform(x, range, [35, 0, -35], { clamp: false });
            return (
              <motion.div key={i} className="carousel-item" style={{ width: itemWidth, minHeight: 180, rotateY: rotY }}>
...
function HeroSection() {
  ...
  return (
    <section id="hero" style={{ minHeight: "100vh", display: "flex", alignItems: "center", position: "relative", overflow: "hidden", paddingTop: 80 }}>
      {/* Background orbs */}
      <div className="orb" style={{ width: 500, height: 500, background: "radial-gradient(circle, rgba(124,58,237,0.25) 0%, transparent 70%)", top: "-10%", left: "-5%", animation: "float 8s ease-in-out infinite" }} />
      <div className="orb" style={{ width: 400, height: 400, background: "radial-gradient(circle, rgba(56,189,248,0.22) 0%, transparent 70%)", top: "5%", right: "5%", animation: "float 10s ease-in-out infinite 2s" }} />
      <div className="orb" style={{ width: 300, height: 300, background: "radial-gradient(circle, rgba(251,113,133,0.18) 0%, transparent 70%)", bottom: "10%", left: "35%", animation: "floatB 7s ease-in-out infinite 1s" }} />

      <div className="section-inner" style={{ width: "100%", zIndex: 1 }}>
        <div className="hero-inner" style={{ display: "flex", alignItems: "center", gap: 64, flexWrap: "wrap" }}>
          {/* Text */}
    ...
    <section id="about">
      <div className="section-inner">
        ...
        <div className="about-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "start" }}>
          <div>
            <BlurText text="I'm Sanjith — an AI/ML engineer from Tiruppur with a deep obsession for building production-grade intelligent systems." delay={40} animateBy="words" className="" />
            <br />
            ...
            <br />
            <BlurText text="8 months of internship experience at Peopleclick Techno Solutions (production RAG, drift monitoring) and Yaane Technologies (NLP pipelines). 2 research publications. Azure AI-900 certified. Now looking for my next challenge." delay={25} animateBy="words" className="" />
          </div>
          <div className="stats-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
            {DATA.stats.map((s, i) => (
              <motion.div key={i} ref={(el) => (tiltRef.current[i] = el)} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="stat-card" onMouseMove={(e) => handleTilt(e, i)} onMouseLeave={() => resetTilt(i)} style={{ "--shimmer-delay": `${i * 0.8}s` }}>
      ...
      <div className="section-inner">
        ...
        <div className="projects-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", rowGap: 80, columnGap: 40, padding: "20px 0" }}>
          {DATA.projects.map((p, i) => (
            <motion.div key={p.id} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.08 }} style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
      ...
      <div className="section-inner">
        ...
        <div>
          {DATA.publications.map((p, i) => (
            <motion.div key={i} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.15 }} className="pub-item">
    ...
    <section id="contact" style={{ paddingBottom: 160 }}>
      <div className="section-inner" style={{ textAlign: "center" }}>
        ...
        <div style={{ display: "flex", justifyContent: "center", gap: 16, flexWrap: "wrap", marginTop: 48 }}>
          {[
            { label: "Email", icon: <img src={gmailLogo} alt="Email" style={{ width: 24, height: 24, objectFit: "contain" }} />, href: `mailto:${DATA.meta.email}`, sub: DATA.meta.email, action: copy, actionLabel: copied ? "Copied!" : "Copy" },
            ...
            <motion.div key={i} ref={(el) => (cardRef.current[i] = el)} onMouseMove={(e) => handleCardMove(e, i)} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} style={{ "--shimmer-delay": `${i * 1}s`, position: "relative", overflow: "hidden", borderRadius: 18 }} className="contact-card-wrap">
              <a href={c.href} target="_blank" rel="noreferrer" className="contact-link" style={{ minWidth: 200 }}>
                <span style={{ fontSize: 28 }}>{c.icon}</span>
                <div>
                  <div style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 15 }}>{c.label}</div>
                  <div style={{ fontSize: 12, color: "var(--subtext)" }}>{c.sub}</div>
                </div>
              </a>
              {c.action && (
                <button onClick={c.action} style={{ position: "relative", zIndex: 3, marginTop: 8, width: "100%", padding: "6px", borderRadius: 10, border: "1px solid rgba(124,58,237,0.2)", background: "rgba(124,58,237,0.06)", cursor: "pointer", fontSize: 12, fontWeight: 600, color: "var(--accent1)" }}>
                  {c.actionLabel}
                </button>
              )}
            </motion.div>
        ...
        <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.5 }} style={{ marginTop: 64, fontSize: 12, color: "var(--subtext)" }}>
          Designed & built by Sanjith G · {new Date().getFullYear()} · Tiruppur → World
        </motion.p>
      </div>
    </section>
  );
